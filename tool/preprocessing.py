...
class Preprocessing:
    ...
    def split(self, data, frac=0.7, seed=None):
        """
        ...
        train = data[random_index[:int(n_samples * frac)]].astype(np.float64)
        test = data[random_index[int(n_samples * frac):]].astype(np.float64)
